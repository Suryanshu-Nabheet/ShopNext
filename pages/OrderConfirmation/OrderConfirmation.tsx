...
const OrderConfirmation: React.FC<OrderConfirmationProps> = ({ orderData, onBackToHome }) => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="border-b border-gray-200 pb-6 mb-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-600">{COMPANY_INFO.city}, {COMPANY_INFO.state} {COMPANY_INFO.zipCode}</p>
                ...
                <tbody>
                  {orderData.isCartOrder ? (
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-3 text-center">{orderData.quantity}</td>
                      <td className="border border-gray-300 px-4 py-3 text-right">${orderData.product.price}</td>
                      <td className="border border-gray-300 px-4 py-3 text-right font-semibold">
                        ${(orderData.product.price * orderData.quantity).toFixed(2)}
                      </td>
                    </tr>
                  )}
                </tbody>
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ${orderData.isCartOrder ? orderData.subtotal.toFixed(2) : (orderData.product.price * orderData.quantity).toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="border-t pt-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-lg font-semibold">${orderData.grandTotal}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="text-gray-600">
              <p>Payment Method: Credit Card ending in ****{orderData.customerInfo.cardNumber.slice(-4)}</p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center text-gray-600">
            <p className="mb-2">Thank you for shopping with ShopNext!</p>
              <p className="text-sm">For questions about your order, contact us at {COMPANY_INFO.email} or {COMPANY_INFO.phone}</p>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Email sent to {orderData.customerInfo.email}</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">

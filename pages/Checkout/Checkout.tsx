 ...
 * Checkout Page
 * 
 * Single product checkout page with form validation and order processing.
 */

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { ArrowLeft, CreditCard, MapPin, User } from 'lucide-react';
import { Product, OrderData, CustomerInfo } from 'types';
...
const Checkout: React.FC<CheckoutProps> = ({ product, quantity, onBack, onOrderComplete }) => {

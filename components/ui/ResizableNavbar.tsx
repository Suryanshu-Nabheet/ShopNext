...
export const NavbarLogo = ({ onClick }: { onClick?: () => void }) => {
  return (
    ...
    >
      <span
        className={cn(
          "text-xl font-bold bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent group-hover:from-blue-700 group-hover:to-blue-900 transition-all duration-200"
        )}
      >
        ShopNext
      </span>

...
export const HoverBorderGradient = ({
  ...
  return (
    <div className={cn("group relative", containerClassName)}>
      <div
        className="absolute -inset-0.5 rounded-full opacity-0 blur transition-opacity duration-500 group-hover:opacity-100 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:200%_200%] animate-gradient"
      />
      <Component
        className={cn(
